...
export const SAMPLE_CATTLE: CattleRecord[] = [
  {
    ...
    aiConfidence: 98.4,
    notes: 'Animal atingiu o peso estimado esperado para o lote e ficou com veredito favorável para registro histórico.',
    landmarkPoints: [
  ...
  },
  {
    ...
    verdict: 'APTO PARA ABATE',
    aiConfidence: 95.2,
    notes: 'Peso estimado dentro da faixa esperada para o lote nesta estação.',
    landmarkPoints: [
  ...
  },
  {
    ...
    verdict: 'NÃO APTO',
    aiConfidence: 89.1,
    notes: 'Escore de condição corporal (2.1) e cobertura de gordura na garupa insuficientes para abate (requer ECC ≥ 3.2 e peso ≥ 420 kg). Recomenda-se estender o período de engorda.',
    landmarkPoints: [
  ...
  },
  {
    ...
    verdict: 'NÃO APTO',
    aiConfidence: 94.7,
    notes: 'Peso estimado (395 kg) e escore de condição corporal (1.4) abaixo dos critérios mínimos para abate (peso ≥ 420 kg e ECC ≥ 3.2). Recomenda-se acompanhamento nutricional e suplementação.',
    landmarkPoints: [
