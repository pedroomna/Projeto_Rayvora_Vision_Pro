...
// Detect if real credentials have been provided or if we're operating with placeholders
...
if (isFirebaseConfigured) {
  try {
    ...
    console.error("Critical: Failed to initialize live Firebase clients: ", error);
  }
}
