...
export default function Sidebar({ 
  ...
  return (
    <>
      ...
      {isOpen && (
        <div 
          className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 md:hidden transition-all duration-300 print:hidden"
          onClick={onClose}
          id="sidebar-overlay"
        />
      )}

      <aside className={`fixed md:sticky top-0 md:top-16 left-0 h-full md:h-[calc(100vh-64px)] w-64 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0e1320] flex flex-col justify-between shrink-0 z-50 transition-all duration-300 ease-in-out md:translate-x-0 print:hidden ${
