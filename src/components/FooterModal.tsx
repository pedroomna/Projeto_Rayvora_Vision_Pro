...
export default function FooterModal({ initialTab, onClose }: FooterModalProps) {
  ...
  const [supportType, setSupportType] = useState('Pesagem e Identificação');
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm transition-opacity duration-300 animate-fade-in font-sans">
      <div className="bg-white dark:bg-[#0e1320] w-full max-w-4xl h-[85vh] md:h-[75vh] flex flex-col rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-sky-400 font-mono mt-0.5">
                Rayvora Vision Pro • Pecuária de Precisão Integrada
              </p>
            </div>
          </div>
          <button 
        ...
        <div className="flex-1 flex flex-col md:flex-row min-h-0 overflow-hidden">
          ...
          {/* Sidebar tabs */}
          <div className="w-full md:w-64 bg-gray-50/50 dark:bg-gray-950/20 border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-800 p-4 flex md:flex-col gap-1.5 overflow-x-auto md:overflow-x-visible shrink-0 scrollbar-none pr-6 md:pr-4">
              ...
              <div className="space-y-6 animate-fade-in-up">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">
                    Termos de Uso do Rayvora Vision Pro
                  </h3>
                  <p className="text-xs text-gray-550 dark:text-sky-400/80 font-mono mt-1">
                    Última Atualização: {new Date().toLocaleDateString('pt-BR', { month: 'long', year: 'numeric' }).replace(/^\w/, (c) => c.toUpperCase())} • Versão 24.2
                  </p>
                </div>
                ...
                <div className="p-4 bg-amber-50 dark:bg-amber-950/20 rounded-xl border border-amber-200 dark:border-amber-900/30 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-800/90 dark:text-amber-400/80 mt-1 leading-relaxed">
                      Todas as estimativas fornecidas pelo sistema — incluindo peso estimado e veredito de aptidão — são resultados de análise visual assistida por IA e devem ser interpretadas com supervisão do responsável pelo manejo.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
                  <div>
                    ...
                    <p>
                      Ao criar ou de forma contínua operar uma conta Rayvora Vision Pro, é concedida a você uma licença pessoal, não-exclusiva e intransferível de uso do software para análise do seu rebanho agropecuário. Todos os dados coletados de peso e registros bovinos do dispositivo pertencem exclusivamente ao usuário licenciado.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      Reservamo-nos o direito de ajustar os algoritmos de visão e processamento para acompanhar melhorias de performance e precisão da ferramenta.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 animate-fade-in-up">
                ...
                <div className="space-y-4 text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
                  <div>
                    ...
                    <p>
                      Vocês, produtores, detêm controle absoluto dos dados em toda a esteira do sistema. Em caso de necessidade de exclusão total ou parcial de registros, exportação de arquivos ou portabilidade, o sistema permite a purgação imediata em um clique.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSendSupport} className="space-y-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          placeholder="Ex: pedro@rayvora.ai"
                          className="w-full h-10 px-3 border border-gray-200 dark:border-blue-950 rounded-xl bg-white dark:bg-gray-900 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-blue-600 dark:focus:border-sky-300 font-sans"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full h-10 px-3 border border-gray-200 dark:border-blue-950 rounded-xl bg-white dark:bg-gray-900 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-blue-600 dark:focus:border-sky-300 font-sans"
                      >
                        <option value="Pesagem e Identificação">Problemas na estimativa de peso ou identificação do animal</option>
                        <option value="Calibração de Câmera">Calibração e foco da câmera</option>
                        <option value="Banco de Lotes">Sincronização de registros e dados offline</option>
                        <option value="Planilhas e PDF">Dificuldade em exportar registros ou CSV</option>
                      </select>
                    </div>
